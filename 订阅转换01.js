...
function overwriteRules(params) {
	...
	const ruleProviders = {
		steam: {
			type: "http",
			behavior: "classical",
			url: "https://cdn.jsdelivr.net/gh/yangtb2024/Mihomo-Rules@refs/heads/main/Steam.txt",
		...
		Microsoft: {
			type: "http",
			behavior: "classical",
			url: "https://cdn.jsdelivr.net/gh/yangtb2024/Mihomo-Rules@refs/heads/main/microsoft.txt",
		...
		AD: {
		  type: "http",
		  behavior: "domain",
		  url: "https://cdn.jsdelivr.net/gh/earoftoast/clash-rules@main/AD.yaml",
		  path: "./rules/AD.yaml",
		  interval: 86400,
		},
		EasyList: {
		  type: "http",
		  behavior: "domain",
		  url: "https://cdn.jsdelivr.net/gh/earoftoast/clash-rules@main/EasyList.yaml",
		...
		EasyListChina: {
		  type: "http",
		  behavior: "domain",
		  url: "https://cdn.jsdelivr.net/gh/earoftoast/clash-rules@main/EasyListChina.yaml",
		...
		EasyPrivacy: {
		  type: "http",
		  behavior: "domain",
		  url: "https://cdn.jsdelivr.net/gh/earoftoast/clash-rules@main/EasyPrivacy.yaml",
		...
		ProgramAD: {
		  type: "http",
		  behavior: "domain",
		  url: "https://cdn.jsdelivr.net/gh/earoftoast/clash-rules@main/ProgramAD.yaml",
